...
$test->assertEquals("Déverouillage{[newline]}Déconnexion{[newline]}Import grille{[newline]}Menu de l application{[newline]}Résumé{[newline]}Modifier mon compte",$rec["actions"],"Valeur de grid [0,actions]");
