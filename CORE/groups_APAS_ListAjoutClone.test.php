...
$test->assertEquals(13,count($comp->m_records),"Nb grid records de groupright");
$act=$comp->m_actions[0];
...
$test->assertEquals("Acceder à l`application",$rec["description"],"Valeur de grid [0,description]");
$test->assertEquals("Déverouillage{[newline]}Déconnexion{[newline]}Import grille{[newline]}Menu de l application{[newline]}Modifier mon compte",$rec["actions"],"Valeur de grid [0,actions]");
...
$rec=$comp->m_records[$key[12]];
$test->assertEquals("Status de l`application",$rec["description"],"Valeur de grid [1,description]");
$test->assertEquals("Résumé",$rec["actions"],"Valeur de grid [1,actions]");
$test->assertEquals("Oui",$rec["value"],"Valeur de grid [1,value]");
