...
else if($xfer_result->confirme("Voulez-vous réaliser une restauration du fichier '$file_path'?{[newline]}{[bold]}Attention:{[/bold]}{[italic]}Toutes les données actuelles seront perdues.{[italic]}")) {
