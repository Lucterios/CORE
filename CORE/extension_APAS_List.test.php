...
// --- Last modification: Date 02 March 2011 13:19:38 By  ---
...
$test->assertEquals("1.2.",substr($comp->m_records["100"]['Version#|#$versionMaj.$versionMin.$versionRev.$versionBuild'],0,4));
