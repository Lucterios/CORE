...
// --- Last modification: Date 17 June 2009 0:27:33 By  ---
...
$test->assertEquals("0.91",substr($comp->m_records["100"]['Version#|#$versionMaj.$versionMin.$versionRev.$versionBuild'],0,4));
