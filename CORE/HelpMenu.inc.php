...
// --- Last modification: Date 23 November 2007 23:59:15 By Pierre-Olivier VERSCHOORE ---
...
function showMenuItem($menu_item)
{
	...
	if (count($list_menu)>0)
	{
		...
		foreach($list_menu as $desc)
			$item_text.="<li><a href='HelpDefault.inc.php?extension=$extension&helpname=". $desc[0]. "' target='MainFrame'>".$desc[1]."</a></li>";
		$item_text.="</div>";
		echo $item_text;
	}
}

if (array_key_exists('mode',$_GET) && ($_GET['mode']=='xml'))
{
...
<table class='Main' width='100%'>
	...
	<tr class='pied'>
		...
		<tr><td class='pied'>
                        $extention_description - Guide d'utilisation
                    </td></tr>
            	</table>
        		</td>
    	</tr>
