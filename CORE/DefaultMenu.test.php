...
$test->assertEquals(3,count($rep->m_main_menus->m_sub_menus));

// General
$menu_general=$rep->m_main_menus->m_sub_menus[0];
$test->assertEquals("_General",$menu_general->m_id);
$test->assertEquals("_Général",$menu_general->m_title);
$test->assertEquals("CORE",$menu_general->m_extension);
$test->assertEquals("",$menu_general->m_action);
$test->assertEquals(1,count($menu_general->m_sub_menus));

// Mot de passe
$menu_item=$menu_general->m_sub_menus[0];
...
// Administration
$menu_admin=$rep->m_main_menus->m_sub_menus[1];
...
$test->assertEquals(5,count($menu_admin->m_sub_menus));
...
// Bar lattérale
$menu_latteral=$rep->m_main_menus->m_sub_menus[2];
