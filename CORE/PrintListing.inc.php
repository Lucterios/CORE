...
class PrintListing
{
	...
	/**
	 * Hauteur des enêtes et des pieds de page (mm)
	 *
	 * @var int
	 */
	...
	private function getListHeader()
	{
		...
		$content.=sprintf('<text height="%1$d.0" width="%2$d.0" top="0.0" left="0.0" padding="1.0" spacing="0.0" border_color="black" border_style="" border_width="0.2" text_align="center" line_height="12" font_family="sans-serif" font_weight="" font_size="12">',$this->HeaderFooterHeight,$this->Width-2*$this->MargeHorizontal);
	...
	private function getListBody()
	{
		...
		foreach($this->GridHeader as $column) {
			...
			$content.='<cell data="" display_align="center" border_color="black" border_style="solid" border_width="0.2" text_align="center" line_height="12" font_family="sans-serif" font_weight="" font_size="10">';
