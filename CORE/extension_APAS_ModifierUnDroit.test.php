...
function CORE_extension_APAS_testModifierUnDroit($test) 
{
//@CODE_ACTION@
	$rep=$test->CallAction("CORE","group_rights_APAS_modify",array("right"=>"105","groupright"=>"127"),"Xfer_Container_Acknowledge");
	...
	$test->assertEquals("Non",$comp->m_records[$keys[2]]['value'],"conseil");
