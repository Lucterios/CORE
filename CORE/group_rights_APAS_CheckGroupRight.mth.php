...
function group_rights_APAS_CheckGroupRight(&$self,$right,$weigth,$extensionId,$rightId)
{
//@CODE_ACTION@
$return="";
$self->rightref=$right;
...
while ($DBObjgroups->fetch())
  if (!in_array($DBObjgroups->id,$groups))
    $notgroups[$DBObjgroups->id]=array($DBObjgroups->groupId,$DBObjgroups->weigth);
